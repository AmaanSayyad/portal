...
Replace `<APP_MODULE_ADDRESS>` with the address of the app under the **NFT Collection** module that was created.

Replace `<ROYALTY_SPLITS_ADDRESS>` with the new recipient address, it needs to be a **Royalty Splits** module.
