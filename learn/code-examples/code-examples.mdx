...
First, we'll set up our local environment, which we'll be the same for all snippets on the page, and then feel free to go and pick up the one you need.

## Set up a local environment

The starting code for these examples can be found on this [GitHub repository](https://github.com/nftlabs/examples/tree/main/typescript/typescript-sdk), so feel free to clone this instead of doing it yourself.
...
Don't commit this `PRIVATE_KEY` to GitHub or anywhere else, don't use it on Repl.it, you will lose your funds, we recommend using a Dev wallet instead of your real wallet.
<br />
...
You should create a `.gitignore` file and add this line before committing to GitHub.
