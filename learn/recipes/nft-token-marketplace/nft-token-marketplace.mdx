...
We’re almost there! This step is pretty simple. Go to the dashboard, create a **module** in your project and pick `Marketplace` as your module.
...
NO dependency on someone else's smart-contract for YOUR NFTs

NO dependency on someone else’s tokens.

NO dependency on someone else’s marketplace.
