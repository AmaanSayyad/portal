...
Go ahead and create a new TypeScript file. Let's call it `index.ts` and open it in your favourite code editor. We'll use VS code.
...
Let's take the code step by step. In the end, we'll include a full code snippet.
...
In our index.ts file, we include the following code. First we define a variable `market_smart_contract_address` and store our module address here.
