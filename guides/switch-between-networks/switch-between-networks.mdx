...
There are different types of blockchain. Just like cloud. You have google cloud and apple cloud. In the blockchain world, it's the same. The two most popular ones for NFTs are Ethereum and Polygon.
...
If you log in to the thirdweb for the first time, you can pick a network at the second step. Please note, after switching networks, you might be guided back to step 1: "Let's get started". If this is the case, please continue to follow the page by pressing "Let's get started" and do not skip steps.
...
At this stage, you might be signed out. No worries. Click on connect wallet and pick your wallet. And now you'll see that you've switched to Polygon.
...
And now you'll see that you've switched to Polygon. 
...
After connecting your wallet via Walletconnect and choosing a rainbow wallet, your network should automatically be the same as your network in the previous step. If it isn't, manually select the **same** network. If you want to switch networks, this will be shown in the next step.
