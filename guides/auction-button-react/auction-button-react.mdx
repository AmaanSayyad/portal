...
Let's take it to step by step, but feel free to scroll to the bottom to copy the full piece of code.
...
First we declare some variables that will be passed through a form such as tokens Id's, listings Id's and the amounts.
