...
Once you minted the NFT, it's available to be claimed. We can even claim it ourselves! To see how this works click on the **Claim Next Available**.
...
You can also check out all the transactions you created on etherscan.io 
