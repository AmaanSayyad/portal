...
You will notice as you perform many of the steps in this walkthrough, your wallet will prompt you to accept transactions. **thirdweb is not charging you anything**, it's the gas costs of deploying the contracts **from your address**, so you can own the contracts.
...
- **Royalty**: The % of the money you'll get from any secondary sales (For example any time your NFT gets sold on OpenSea after the mint).

### Configure the drop

The next thing we'll do, configures the drop, these are my settings for this drop:

![Drop settings](./drop-module-settings.png)

So let's explain what each of these does!
...
- **Wait time (seconds)**: The amount of time people need to wait until they can mint again after they have minted once. (Click "**Max**" if you only want them to mint once).
- **Claim limit per transaction**: The maximum number of NFTs you want them to be able to claim in one transaction (helps save money on gas). 
...
You're now a blockchain expert! If you want to go ahead and mint some Pokémon from my site, here's [the link](https://pokemongen1.carrd.co/). Remember there are only 151 available!
...
I hope you have enjoyed this guide, if you create your own collection with this, please send it to me on [Discord](https://discord.gg/thirdweb) or Twitter [@nachoiacovino](https://twitter.com/nachoiacovino).
